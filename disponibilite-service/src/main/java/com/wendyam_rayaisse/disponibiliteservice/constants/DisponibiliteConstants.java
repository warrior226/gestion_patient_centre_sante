package com.wendyam_rayaisse.disponibiliteservice.constants;

public class DisponibiliteConstants {

    public DisponibiliteConstants(){

    }
    public static final String  STATUS_201 = "201";
    public static final String  MESSAGE_201 = "Création de disponibilite réussie";
